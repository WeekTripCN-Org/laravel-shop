            ...
            <td colspan="4">
              <form action="{{ route('admin.orders.ship', [$order->id]) }}" class="form-inline" method="post">
                ...
                <div class="form-group {{ $errors->has('express_company') ? 'has-error' : ''}}">
                  ...
                  <input type="text" id="express_company" name="express_company" class="form-control" value="" placeholder="输入物流公司">
                ...
                <div class="form-group {{ $errors->has('express_no') ? 'has-error' : ''}}">
                  ...
                  <input type="text" id="express_no" name="express_no" class="form-control" value="" placeholder="输入物流单号">
